            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-9 w-auto fill-current text-white dark:text-black-200" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('category-products.index')" :active="request()->routeIs('category-products.index')">
                        {{ __('Kategori Produk') }}
                    </x-nav-link>
                </div>
            </div>
