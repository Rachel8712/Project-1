...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $current_image_path = mysqli_real_escape_string($conn, $_POST['current_image_path']); // Ambil jalur gambar saat ini
    ...
    if($stmt->execute()) {
        header("Location: index_new.php?pesan=update_success");
        exit();
    } else {
...
<body>
    <div class="container mt-5">
        ...
        <?php else: ?>
            ...
            <a href="index_new.php" class="btn btn-secondary">Kembali ke Daftar Produk</a>
        <?php endif; ?>
    </div>
