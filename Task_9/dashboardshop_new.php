            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="view_cart.php">Keranjang</a>
                        </li>
                    </ul>
                </div>
            </div>
       ...
       <div class="filter-section">
            <form method="GET" class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <a href="index_new.php" class="btn btn-secondary">Reset</a>
                </div>
            </form>
        </div>
        ...
        <div class="row">
            ...
            if ($resultProducts->num_rows > 0) {
                while($row = $resultProducts->fetch_assoc()) {
                    ...
                    echo '<form action="add_to_cart.php" method="POST" class="d-inline">';
                    ...
                    echo '<input type="number" name="quantity" value="1" min="1" class="form-control form-control-sm d-inline w-auto">';
                    echo '<button type="submit" class="btn btn-success btn-sm">Tambah ke Keranjang</button>';
                    echo '</form>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
