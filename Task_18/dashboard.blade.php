                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card bg-primary-subtle">
                                    ...
                                    <div class="card-body text-black">
                                        <h1 class="card-title fw-bold" style="font-size: 30px;">300</h1>
                            ...
                            <div class="col-md-4">
                                <div class="card bg-success-subtle ">
                                    ...
                                    <div class="card-body text-black">
                                        <h1 class="card-title fw-bold" style="font-size: 30px;">14.000</h1>
                            ...
                            <div class="col-md-4">
                                <div class="card bg-warning-subtle">
                                    ...
                                    <div class="card-body text-black">
                                        <h1 class="card-title fw-bold" style="font-size: 30px;">5</h1>
